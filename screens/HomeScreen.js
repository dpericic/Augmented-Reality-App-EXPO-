      ...
      <View style={{flex:1}}>
        ...
        <View style={{position:"absolute", bottom: 0, flex: 1, flexDirection: "row"}}>
          <View style={{flex: 1, flexDirection: "row", justifyContent: "space-between"}}>
            <Icon.Button size={40} name="md-cog" backgroundColor="transparent" onPress={this.onAddObjectPress} />
            <Icon.Button size={40} name="md-compass" backgroundColor="transparent" onPress={this.onSearchModalPress} />
            <Icon.Button size={40} name="md-contact" backgroundColor="transparent" onPress={this.onRemoveObjectPress} />
          </View>
        </View>
